...
interface TaxFormData {
  taxYear: number;
  entityType: 'LLC' | 'S-Corp' | 'Sole Proprietorship' | 'Partnership';
  totalRevenue: number;
  cogs: number;
